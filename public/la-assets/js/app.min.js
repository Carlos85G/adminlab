...
function addToggleCheck(el){
  el.parent().find("input:checkbox").length && (el.parent().find("input:checkbox").hasClass("show") || el.parent().find("input:checkbox").hide(), el.parent().find("input:checkbox").is(":checked") ? el.removeClass("On").addClass("Off") : el.removeClass("Off").addClass("On"));
