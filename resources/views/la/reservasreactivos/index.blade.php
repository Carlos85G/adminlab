...
@section("contentheader_title", "Reservaci&oacute;n de Reactivos")
@section("contentheader_description", "Listado de Reservaciones de Reactivos")
@section("section", "Reservaciones de Reactivos")
@section("sub_section", "Listado")
@section("htmlheader_title", "Listado de Reservaciones de Reactivos")
...
<div class="modal fade" id="AddModal" role="dialog" aria-labelledby="myModalLabel">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			{!! Form::open(['action' => 'LA\ReservasReactivosController@store', 'id' => 'reservasreactivo-add-form']) !!}
...
$(function () {
	$("#example1").DataTable({
		processing: true,
        serverSide: true,
        ajax: "{{ url(config('laraadmin.adminRoute') . '/reservasreactivo_dt_ajax') }}",
	...
	$("#reservasreactivo-add-form").validate({
