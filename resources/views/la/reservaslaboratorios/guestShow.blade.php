@extends('la.layouts.guestApp')

@section('htmlheader_title')
	Vista de Reservaci&oacute;n de Laboratorio
@endsection
...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{-- $reservaslaboratorio->$view_col --}}{{ $reservaslaboratorio->laboratorio->nombre }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			<?php /*@la_access("ReservasLaboratorios", "edit")
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/reservaslaboratorios') }}" data-toggle="tooltip" data-placement="right" title="Regresar a Reservaciones de Laboratorios"><i class="fa fa-chevron-left"></i></a></li>
				...
				<div class="panel infolist">
					...
					<div class="panel-body">
						...
						<div class="form-group">
							...
							<div class="col-md-10 fvalue">{{ $reservaslaboratorio->laboratorio->nombre }}</div>
						</div>
						@php
							$dti = new Datetime($reservaslaboratorio->fecha_inicio);
							$dtf = new Datetime($reservaslaboratorio->fecha_fin);
						@endphp
						<div class="form-group">
							<label for="fecha_inicio" class="col-md-2">Fecha de Inicio :</label>
							<div class="col-md-10 fvalue">{{ $dti->format("j F Y, g:i A") }}</div>
						</div>
						<div class="form-group">
							<label for="fecha_fin" class="col-md-2">Fecha de Fin :</label>
							<div class="col-md-10 fvalue">{{ $dtf->format("j F Y, g:i A") }}</div>
						</div>
						<div class="form-group">
							<label for="solicitante_id" class="col-md-2">Solicitante :</label>
							<div class="col-md-10 fvalue">
								{{ $reservaslaboratorio->solicitante->name }}
							</div>
						</div>
					</div>
				</div>
