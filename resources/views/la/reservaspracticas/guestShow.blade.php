...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		...
		<div class="col-md-1 actions">
			<?php /*@la_access("ReservasPracticas", "edit")
				...
				<div class="panel infolist">
					...
					<div class="panel-body">
						...
						<div class="form-group">
							...
							@php
								$dt = new Datetime($reservaspractica->fecha_inicio);
							@endphp
							<div class="col-md-10 fvalue">{{ $dt->format("j F Y, g:i A") }}</div>
						</div>
						<div class="form-group">
							<label for="solicitante_id" class="col-md-2">Solicitante :</label>
							<div class="col-md-10 fvalue">
								{{ $reservaspractica->solicitante->name }}
							</div>
						</div>
					</div>
				</div>
				...
				<div class="panel infolist">
					...
					<div class="panel-body">
						<div class="form-group">
							...
							<div class="col-md-10 fvalue">{{ $practica->nombre }}</div>
						</div>
						<div class="form-group">
							<label for="objetivo" class="col-md-2">Objetivo :</label>
							<div class="col-md-10 fvalue">
								{{ $practica->objetivo }}
							</div>
						</div>
						...
						@if(is_numeric($practica->practica_pdf))
						@php
							$upload = \App\Models\Upload::find($practica->practica_pdf);
						@endphp
						@if(isset($upload->id))
						<div class="form-group">
							<label for="practica_pdf" class="col-md-2">Descargable  :</label>
							<div class="col-md-10 fvalue">
								<a class="preview" target="_blank" href="{{ url('files/'.$upload->hash.DIRECTORY_SEPARATOR.$upload->name) }}">
