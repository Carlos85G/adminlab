...
@section("contentheader_title", "Reservaci&oacute;n de Material")
@section("contentheader_description", "Listado de Reservaciones de Materiales")
@section("section", "Reservaciones de Materiales")
@section("sub_section", "Listado")
@section("htmlheader_title", "Listado de Reservaciones de Materiales")
...
<div class="modal fade" id="AddModal" role="dialog" aria-labelledby="myModalLabel">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			{!! Form::open(['action' => 'LA\ReservasMaterialesController@store', 'id' => 'reservasmateriale-add-form']) !!}
...
$(function () {
	$("#example1").DataTable({
		processing: true,
        serverSide: true,
        ajax: "{{ url(config('laraadmin.adminRoute') . '/reservasmateriale_dt_ajax') }}",
	...
	$("#reservasmateriale-add-form").validate({
