...
@section("contentheader_title", "Pr&eacute;stamo de Material")
@section("contentheader_description", "Listado de Pr&eacute;stamos de Materiales")
@section("section", "Pr&eacute;stamos de Materiales")
@section("sub_section", "Listado")
@section("htmlheader_title", "Listado de Pr&eacute;stamos de Materiales")

@section("headerElems")
@la_access("ReservasMateriales", "create")
...
<div class="modal fade" id="AddModal" role="dialog" aria-labelledby="myModalLabel">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			{!! Form::open(['action' => 'LA\PrestamosMaterialesController@store', 'id' => 'prestamosmateriale-add-form']) !!}
...
$(function () {
	$("#example1").DataTable({
		processing: true,
        serverSide: true,
        ajax: "{{ url(config('laraadmin.adminRoute') . '/prestamosmateriale_dt_ajax') }}",
	...
	$("#prestamosmateriale-add-form").validate({
