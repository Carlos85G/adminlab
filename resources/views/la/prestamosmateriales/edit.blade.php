...
@section("contentheader_title")
	<a href="{{ url(config('laraadmin.adminRoute') . '/prestamosmateriales') }}">Pr&eacute;stamo de Material</a> :
@endsection
@section("contentheader_description", $reservasmateriale->$view_col)
@section("section", "Pr&eacute;stamo de Material")
@section("section_url", url(config('laraadmin.adminRoute') . '/prestamosmateriales'))
@section("sub_section", "Edici&oacute;n")

@section("htmlheader_title", "Edici&oacute;n de Pr&eacute;stamo de Material : ".$reservasmateriale->$view_col)
	...
	<div class="box-body">
		<div class="row">
			<div class="col-md-8 col-md-offset-2">
				{!! Form::model($reservasmateriale, ['route' => [config('laraadmin.adminRoute') . '.prestamosmateriales.update', $reservasmateriale->id ], 'method'=>'PUT', 'id' => 'prestamosmateriale-edit-form']) !!}
					{{--@la_form($module)--}}
                    ...
                    <br>
					<div class="form-group">
						{!! Form::submit( 'Actualizar', ['class'=>'btn btn-success']) !!} <button class="btn btn-default pull-right"><a href="{{ url(config('laraadmin.adminRoute') . '/prestamosmateriales') }}">Cancelar</a></button>
					</div>
				{!! Form::close() !!}
			</div>
		</div>
...
<script>
$(function () {
	$("#prestamosmateriale-edit-form").validate({
